...
exec(open('/home/devasmit/Desktop/PyPonding/studies/reliability/Boise Idaho analysis design cases copy 2/100yr-Durations/fragility_assessment Idaho sensitivity.py').read())
