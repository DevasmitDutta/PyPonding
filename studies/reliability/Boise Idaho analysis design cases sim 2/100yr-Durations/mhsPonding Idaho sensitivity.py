...
exec(open('/home/devasmit/Desktop/PyPonding/studies/reliability/Boise Idaho analysis design cases sim 2/100yr-Durations/fragility_assessment Idaho sensitivity.py').read())
# run_analysis_multiple_periods('W14X22',360.0,0.020833333333333332,6.944444444444444e-05,1976)
# shapes = ['W6X20','W10X12','W12X14']
shapes = ['W14X22', 'W12X22','W10X22','W8X28']
