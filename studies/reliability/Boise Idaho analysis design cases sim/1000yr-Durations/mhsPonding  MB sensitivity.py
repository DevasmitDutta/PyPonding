...
exec(open('/home/devasmit/Desktop/PyPonding/studies/reliability/Boise Idaho analysis design cases sim/1000yr-Durations/fragility_assessment MB sensitivity.py').read())
# shapes = ['W10X15', 'W8X18', 'W6X25']
# shapes = ['W6X25']
# shapes = ['W8X24','W12X14','W8X18']
shapes = ['W12X14']
