...
window_sizes = [10, 40] # [5, 10, 15, 20, 25, 30, 35, 40] #np.arange(5,41,1)  # Generates values from 1 to 10 with a step size of 1
...
def duration_window_wise(window_size, duration):
    ...
    threshold_num = np.random.uniform(0, 0.1, num_samples)
    cnt = 0
