...
def fit_fragility_curve():    
        ...
        data_1 = pd.read_csv(os.path.join(os.getcwd(), f'studies/reliability/Denver i_mean design performance period fragility risk hazard/Fragility_trials/fragility_data_points1976.csv'))
        # Assume the CSV file has columns named 'IM' and 'num_collapse' and 'num_gms'
        IM = np.linspace(4,6,100)
        ...
        results_df.to_csv(f'studies/reliability/Denver i_mean design performance period fragility risk hazard/Fragility_fit/mu_sigma_opt_durationwise.csv', index=False)
        ...
        plt.grid(True)
        plt.savefig(f'studies/reliability/Denver i_mean design performance period fragility risk hazard/Fragility_fit/fitted_plot.png')
