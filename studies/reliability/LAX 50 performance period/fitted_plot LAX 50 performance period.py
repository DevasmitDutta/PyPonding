...
for i, duration in enumerate(durations):
    ...
    if duration == 'x1hr':
        ...
        data_1 = pd.read_csv(os.path.join(os.getcwd(), f'studies/reliability/LAX 50 performance period/Fragility_trials_{duration}/fragility_data_points1976.csv'))
        ...
        plt.title('Fragility Function Fitting (1 hr duration)- LAX  (50 yr performance period)')
        plt.legend(loc='best', fontsize=8)
        plt.grid(True)
        plt.savefig('studies/reliability/LAX 50 performance period/Fragility_fit/fitted_plot_1hr.png')
...
results_df.to_csv(f'studies/reliability/LAX 50 performance period/Fragility_fit/mu_sigma_opt_durationwise.csv', index=False)

# Add labels and title
plt.xlabel('IM')
plt.ylabel('Probability of Limit State of Exceedance') 
plt.title('Theoritical Fragility Curves - LAX  (50 yr performance period)')
plt.legend(loc='best', fontsize=8)
plt.grid(True)
plt.savefig('studies/reliability/LAX 50 performance period/Fragility_fit/duration_comparision_plot.png')
