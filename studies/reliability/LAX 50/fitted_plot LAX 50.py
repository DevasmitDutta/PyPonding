...
for i, duration in enumerate(durations):
    ...
    if duration == 'x1hr':
        ...
        data_1 = pd.read_csv(os.path.join(os.getcwd(), f'studies/reliability/LAX 50/Fragility_trials_{duration}/fragility_data_points1976.csv'))
...
results_df.to_csv(f'studies/reliability/LAX 50/Fragility_fit/mu_sigma_opt_durationwise.csv', index=False)
