...
for i, duration in enumerate(durations):
    ...
    if duration == 'x0.25hr':
        ...
        plt.grid(True)
        plt.savefig(f'studies/reliability/LAX sensitivity analysis copy/100yr-Durations/Fragility_fit/fitted_plot_{duration}.png')
...
results_df.to_csv(f'studies/reliability/LAX sensitivity analysis copy/100yr-Durations/Fragility_fit/mu_sigma_opt_durationwise.csv', index=False)
...
plt.legend(loc='best', fontsize=8)
plt.grid(True)
plt.savefig(f'studies/reliability/LAX sensitivity analysis copy/100yr-Durations/Fragility_fit/duration_comparision_plot.png')
