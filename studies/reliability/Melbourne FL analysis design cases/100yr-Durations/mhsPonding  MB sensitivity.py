...
exec(open('/home/devasmit/Desktop/PyPonding/studies/reliability/Melbourne FL analysis design cases/100yr-Durations/fragility_assessment MB sensitivity.py').read())
# run_analysis_multiple_periods('W14X22',360.0,0.020833333333333332,6.944444444444444e-05,1976)

shapes = ['W14X22','W10X12','W12X14']
