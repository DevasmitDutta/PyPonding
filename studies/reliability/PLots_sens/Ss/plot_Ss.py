...
dark_colors = list(mcolors.TABLEAU_COLORS.values())[:len(Ss_vector)] 
print(dark_colors)    
...
for duration in durations:
    ...
    for i, Ss in enumerate(Ss_vector):
        data_1 = pd.read_csv(os.path.join(os.getcwd(), f'studies/reliability/LAX analysis sens Ss_{Ss}/100yr-Durations/Fragility_trials_{duration}/fragility_data_points1976.csv'))
...
plt.grid(True)
plt.savefig(f'studies/reliability/PLots_sens/Ss/Ss_comparision_plot.png')
