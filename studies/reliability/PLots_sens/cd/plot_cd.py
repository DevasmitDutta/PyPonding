...
cd_vector = [0.6, 0.8, 0.9]

# Define a dark color palette
dark_colors = list(mcolors.TABLEAU_COLORS.values())[:len(cd_vector)] 
print(dark_colors)    
...
for duration in durations:
    ...
    for i, cd in enumerate(cd_vector):
        data_1 = pd.read_csv(os.path.join(os.getcwd(), f'studies/reliability/LAX analysis sens cd_{cd}/100yr-Durations/Fragility_trials_{duration}/fragility_data_points1976.csv'))
...
plt.grid(True)
plt.savefig(f'studies/reliability/PLots_sens/cd/cd_comparision_plot.png')
