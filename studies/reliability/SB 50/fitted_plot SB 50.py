...
for i, duration in enumerate(durations):
    ...
    if duration == 'x0.25hr':
        ...
        data_1 = pd.read_csv(os.path.join(os.getcwd(), f'studies/reliability/SB 50/Fragility_trials_{duration}/fragility_data_points1976.csv'))
        ...
        plt.title('Fragility Function Fitting (0.25 hr duration)- Santa Barbara (50 yr return period)')
        plt.legend(loc='best', fontsize=8)
        plt.grid(True)
        plt.savefig('studies/reliability/SB 50/Fragility_fit/fitted_plot_1hr.png')
...
results_df.to_csv(f'studies/reliability/SB 50/Fragility_fit/mu_sigma_opt_durationwise.csv', index=False)
...
plt.legend(loc='best', fontsize=8)
plt.grid(True)
plt.savefig('studies/reliability/SB 50/Fragility_fit/duration_comparision_plot.png')
