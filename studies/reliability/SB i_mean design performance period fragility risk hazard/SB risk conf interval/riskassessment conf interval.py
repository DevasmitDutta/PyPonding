...
plt.legend()
plt.savefig('studies/reliability/SB i_mean design performance period fragility risk hazard/SB risk conf interval/Probability_of_limit_state_exceedance_X_years.png')