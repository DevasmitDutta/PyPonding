...
window_sizes = [5, 10, 25] #np.arange(5,41,1) #[5, 8, 10, 15, 20, 30, 40, 50, 60]  # Generates values from 1 to 10 with a step size of 1
...
plt.legend()
plt.savefig('studies/reliability/SB performance period fragility risk hazard/SB risk conf interval/Probability_of_limit_state_exceedance_X_years.png')