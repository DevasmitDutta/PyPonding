...
def fit_fragility_curve(window_size):    
        ...
        for i, duration in enumerate(durations):
            ...
            if duration == 'x0.25hr':
                ...
                data_1 = pd.read_csv(os.path.join(os.getcwd(), f'studies/reliability/SB performance period fragility risk hazard/SB {window_size} performance period/Fragility_trials_{duration}/fragility_data_points1976.csv'))
                ...
                plt.title(f'Fragility Function Fitting (0.25hr duration)- Santa Barbara ({window_size} yr performance period)')
                plt.legend(loc='best', fontsize=8)
                plt.grid(True)
                plt.savefig(f'studies/reliability/SB performance period fragility risk hazard/SB {window_size} performance period/Fragility_fit/fitted_plot_0.25hr.png')
        ...
        results_df.to_csv(f'studies/reliability/SB performance period fragility risk hazard/SB {window_size} performance period/Fragility_fit/mu_sigma_opt_durationwise.csv', index=False)
        ...
        plt.legend(loc='best', fontsize=8)
        plt.grid(True)
        plt.savefig(f'studies/reliability/SB performance period fragility risk hazard/SB {window_size} performance period/Fragility_fit/duration_comparision_plot.png')
