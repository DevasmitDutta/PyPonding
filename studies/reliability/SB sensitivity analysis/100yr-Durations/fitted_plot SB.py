...
for i, duration in enumerate(durations):
    ...
    if duration == 'x0.25hr':
        ...
        data_1 = pd.read_csv(os.path.join(os.getcwd(), f'studies/reliability/SB sensitivity analysis/100yr-Durations/Fragility_trials_{duration}/fragility_data_points1976.csv'))
        ...
        plt.grid(True)
        plt.savefig(f'studies/reliability/SB sensitivity analysis/100yr-Durations/Fragility_fit/fitted_plot_{duration}.png')
...
results_df.to_csv(f'studies/reliability/SB sensitivity analysis/100yr-Durations/Fragility_fit/mu_sigma_opt_durationwise.csv', index=False)
...
plt.legend(loc='best', fontsize=8)
plt.grid(True)
plt.savefig(f'studies/reliability/SB sensitivity analysis/100yr-Durations/Fragility_fit/duration_comparision_plot.png')
