...
exec(open('/home/devasmit/Desktop/PyPonding/studies/reliability/SB_Design_analysis/15 min/fragility_assessment SB sensitivity.py').read())

for shape in ['W12X30','W12X19','W12X16','W10X15']:
