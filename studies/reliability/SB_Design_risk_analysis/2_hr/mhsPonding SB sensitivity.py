...
exec(open('/home/devasmit/Desktop/PyPonding/studies/reliability/SB_Design_analysis/2_hr/fragility_assessment SB sensitivity.py').read())

# for shape in ['W12X30','W10X22','W10X17','W8X18']:
# for shape in ['W14X26','W10X19','W8X21','W6X25']:
# for shape in ['W10X33','W10X19','W8X18']:
for shape in ['W8X18']:
