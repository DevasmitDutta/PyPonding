...
exec(open('/home/devasmit/Desktop/PyPonding/studies/reliability/doPondingAnalysis copy.py').read())
doPondingAnalysis('W12X16',360.0,0.020833333333333332,6.944444444444444e-05,1976)